...
describe("PRICING SERVICE", () => {
  ...
  describe("PRICING CONSTANTS: Anti-Abuse Constraints", () => {
    ...
    it("should define minimum payout threshold", () => {
      expect(PRICING_CONSTANTS.MIN_PAYOUT_LAMPORTS).toBeGreaterThanOrEqual(
        PRICING_CONSTANTS.MIN_COST_LAMPORTS
      );
    });
  });
  ...
  describe("Edge Cases & Abuse Scenarios", () => {
    ...
    it("should handle very large token counts", () => {
      const largeTokens = 1_000_000_000;
      const rate = 1000;
