...
Write-Host "`n[TEST] Messaging API Test`n" -ForegroundColor Cyan
...
Invoke-RestMethod -Uri "$BASE/identity/verify-identity" -Method POST -Body $body -ContentType "application/json" | Out-Null
Write-Host "   [OK] Agents registered" -ForegroundColor Green
...
Write-Host "   [OK] Request sent. Conversation ID: $convId" -ForegroundColor Green
...
Write-Host "   [OK] Has activity: $($result.has_activity), Pending: $($result.requests.count)" -ForegroundColor Green
...
Write-Host "   [OK] Message sent: $($result.message_id)" -ForegroundColor Green
...
Write-Host "   [OK] Messages: $($result.messages.Count)" -ForegroundColor Green
...
Write-Host "   [OK] Reply sent" -ForegroundColor Green
...
Write-Host "   [OK] Now following" -ForegroundColor Green
...
Write-Host "   [OK] Followers: $($result.stats.followerCount)" -ForegroundColor Green

Write-Host "`n[DONE] All tests passed!`n" -ForegroundColor Cyan
